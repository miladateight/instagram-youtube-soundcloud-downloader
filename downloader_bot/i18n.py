...
BASE_MESSAGES = {
    ...
    "platform_disabled": "{platform} downloads are disabled on this bot.",
    "choose_format": "What do you want from this {platform} link?\n{url}",
    "probing_content": "Checking content...\n{platform}",
    "button_video": "Video",
    "button_audio": "Audio (MP3)",
    "button_find_song": "Find song",
    "button_download_photos": "Download photos",
    "button_download": "Download",
    "button_cancel": "Cancel",
    "link_expired": "This link expired. Please send the link again.",
    "song_searching": "Listening to the audio...\n{platform}\n{url}",
    "song_not_found": "I could not identify the song in this video.\nYou can still download the audio as MP3.",
    "song_found": "Found a match:",
    "song_title": "Title: {title}",
    "song_artist": "Artist: {artist}",
    "song_album": "Album: {album}",
    "song_download": "Download this song",
    "starting_video_download": "Starting video download from {platform}...",
    "starting_audio_download": "Starting audio download from {platform}...",
    "song_detection_unavailable": "Song detection is not configured. Sending audio as MP3 instead.",
    "cookie_help": (
    ...
    "not_found_error": "This link is invalid, removed, or the media was not found.",
    ...
    "error_contact_support": "If the problem persists, contact support.",
    "cookie_broken_notification": "Cookies may be expired or broken. Please upload a fresh cookies.txt.\n\nFailed URL: {url}",
    "button_support": "Support",
    "button_share": "Share",
    "button_about": "About",
    "button_back": "Back",
    "button_download_menu": "Download",
    "button_mp3_menu": "MP3",
    "button_status_menu": "Status",
    "button_language_menu": "Language",
    "button_support_menu": "Support",
    "button_share_menu": "Share",
    "share_message": "Share Atieght Downloader with your friends!\n\n{url}\n\nA fast and friendly Telegram bot for downloading from YouTube, Instagram, and SoundCloud.",
    "about_message": "Atieght Downloader\n\nA private Telegram bot for downloading media from YouTube, Instagram, and SoundCloud.\n\nFeatures:\n- Video, audio (MP3), and song detection\n- Inline buttons for easy choice\n- SoundCloud with album cover\n- Song recognition via Shazam\n\nVersion: 2.0.0",
    "menu_hint": "Use the buttons below or send a link directly.",
...
MESSAGES: dict[str, dict[str, str]] = {
    ...
    "fa": {
        **BASE_MESSAGES,
        ...
        "not_found_error": "این لینک نامعتبر، حذف‌شده، یا پیدا نشد.",
        "error_contact_support": "اگر مشکل ادامه داشت با پشتیبانی در ارتباط باش.",
        "cookie_broken_notification": "به نظر می‌رسد کوکی‌ها منقضی یا خراب شده‌اند. لطفاً یه cookies.txt جدید آپلود کن.\n\nلینک ناموفق: {url}",
        "button_support": "پشتیبانی",
        "button_share": "اشتراک‌گذاری",
        "button_about": "درباره",
        "button_back": "بازگشت",
        "button_download_menu": "📥 دانلود",
        "button_mp3_menu": "🎵 MP3",
        "button_status_menu": "📊 وضعیت",
        "button_language_menu": "🌐 زبان",
        "button_support_menu": "🆘 پشتیبانی",
        "button_share_menu": "📤 اشتراک‌گذاری",
        "share_message": "Atieght Downloader رو با دوستات به اشتراک بذار!\n\n{url}\n\nیه ربات تلگرامی سریع و ساده برای دانلود از یوتیوب، اینستاگرام و ساندکلاد.",
        "about_message": "Atieght Downloader\n\nیه ربات تلگرامی خصوصی برای دانلود از یوتیوب، اینستاگرام و ساندکلاد.\n\nامکانات:\n- فیلم، صدا (MP3) و تشخیص آهنگ\n- دکمه‌های شیشه‌ای برای انتخاب آسون\n- ساندکلاد با کاور آلبوم\n- تشخیص آهنگ با شزم\n\nنسخه: 2.0.0",
        "menu_hint": "از دکمه‌های پایین استفاده کن یا لینک رو مستقیم بفرست.",
        ...
        "platform_disabled": "دانلود از {platform} روی این ربات غیرفعال است.",
        "choose_format": "از این لینک {platform} چه چیزی می‌خوای؟\n{url}",
        "probing_content": "در حال بررسی محتوا...\n{platform}",
        "button_video": "فیلم",
        "button_audio": "صدا (MP3)",
        "button_find_song": "پیدا کردن آهنگ",
        "button_download_photos": "دانلود عکس‌ها",
        "button_download": "دانلود",
        "button_cancel": "انصراف",
        "link_expired": "این لینک منقضی شده. لطفاً لینک رو دوباره بفرست.",
        "song_searching": "در حال گوش دادن به صدا...\n{platform}\n{url}",
        "song_not_found": "نتونستم آهنگ داخل این ویدیو رو پیدا کنم.\nمی‌تونی صداش رو به‌عنوان MP3 دانلود کنی.",
        "song_found": "پیدا شد:",
        "song_title": "اسم آهنگ: {title}",
        "song_artist": "خواننده: {artist}",
        "song_album": "آلبوم: {album}",
        "song_download": "دانلود این آهنگ",
        "starting_video_download": "در حال شروع دانلود فیلم از {platform}...",
        "starting_audio_download": "در حال شروع دانلود صدا از {platform}...",
        "song_detection_unavailable": "تشخیص آهنگ تنظیم نشده. در عوض صدا رو به‌عنوان MP3 می‌فرستم.",
    },
    "ar": {
        **BASE_MESSAGES,
